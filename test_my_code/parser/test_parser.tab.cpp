...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* ROOT: EXPR  */
#line 37 "parser/test_parser.y"
            { std::cout<<"start"; }
#line 1127 "parser/test_parser.tab.cpp"
    break;

  case 3: /* EXPR: IDENTIFIER  */
#line 40 "parser/test_parser.y"
                     {(yyval.expr)= new Variable(*(yyvsp[0].string));}
#line 1133 "parser/test_parser.tab.cpp"
    break;


#line 1137 "parser/test_parser.tab.cpp"
